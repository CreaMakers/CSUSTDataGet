package com.dcelysia.csust_spider.login.sso.repositroy
    ...
    fun login(username: String, password: String) = flow {
        ...
        var loginResponse = KtorUtils.ssoAuthClient.submitForm(
            ...
            header(
                ...
                "https://authserver.csust.edu.cn/authserver/login?service=$SERVICE_URL"
            )
        }
        if (loginResponse.status == HttpStatusCode.Companion.Found) {
