package com.dcelysia.csust_spider.login.mooc.repository
...
import com.dcelysia.csust_spider.login.mooc.dto.MoocProfile
import com.dcelysia.csust_spider.login.mooc.dto.MoocTest
import com.dcelysia.csust_spider.login.mooc.dto.PendingAssignmentCourse
...
// val rawUrl = "${urlObj.protocol.name}://${urlObj.user}:${urlObj.password}@${urlObj.host}${urlObj.encodedPathAndQuery}"
    ...
    fun getCourseNamesWithPendingHomeworks(): Flow<Resource<List<PendingAssignmentCourse>>> = flow {
        ...
        val response =
            KtorUtils.moocClient.get("meol/welcomepage/student/interaction_reminder_v8.jsp")
